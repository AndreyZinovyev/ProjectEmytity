...
namespace ProjectEmytity {
    ...
    public partial class DBDataSet : global::System.Data.DataSet {
        ...
        public partial class adminDataTable : global::System.Data.TypedTableBase<adminRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public adminRow AddadminRow(int Id, string login, string pass, string name, string lastname, string tel) {
            ...
            public string pass {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'pass\' в таблице \'admin\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string tel {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'tel\' в таблице \'admin\' равно DBNull.", e);
                    }
                }
                set {
...
namespace ProjectEmytity.DBDataSetTableAdapters {
    ...
    public partial class adminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[admin] WHERE (([Id] = @Original_Id) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_tel = 1 AND [tel] IS NULL) OR ([tel] = @Original_tel)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[admin] ([Id], [login], [pass], [name], [lastname], [tel]) VALU" +
                "ES (@Id, @login, @pass, @name, @lastname, @tel);\r\nSELECT Id, login, pass, name, " +
                "lastname, tel FROM admin WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[admin] SET [Id] = @Id, [login] = @login, [pass] = @pass, [name] = @name, [lastname] = @lastname, [tel] = @tel WHERE (([Id] = @Original_Id) AND ((@IsNull_login = 1 AND [login] IS NULL) OR ([login] = @Original_login)) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_tel = 1 AND [tel] IS NULL) OR ([tel] = @Original_tel)));
SELECT Id, login, pass, name, lastname, tel FROM admin WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectEmytity.Properties.Settings.Default.DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, login, pass, name, lastname, tel FROM dbo.admin";
        ...
        public virtual int Delete(int Original_Id, string Original_login, string Original_pass, string Original_name, string Original_lastname, string Original_tel) {
        ...
        public virtual int Insert(int Id, string login, string pass, string name, string lastname, string tel) {
        ...
        public virtual int Update(int Id, string login, string pass, string name, string lastname, string tel, int Original_Id, string Original_login, string Original_pass, string Original_name, string Original_lastname, string Original_tel) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string pass, string name, string lastname, string tel, int Original_Id, string Original_login, string Original_pass, string Original_name, string Original_lastname, string Original_tel) {
            return this.Update(Original_Id, login, pass, name, lastname, tel, Original_Id, Original_login, Original_pass, Original_name, Original_lastname, Original_tel);
        }
    }
